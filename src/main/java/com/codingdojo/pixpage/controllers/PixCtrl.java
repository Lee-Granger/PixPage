...
//********************************************************************************
@RequestMapping("/comment/delete/{id}/{imageId}")
public String deleteComment(HttpSession session, @PathVariable("id") Long id, @PathVariable("imageId") Long imageId) {
	appServ.deleteComment(id);
	return "redirect:/image/view/" + imageId;
}
//********************************************************************************
}
